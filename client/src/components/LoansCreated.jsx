...
class LoansCreated extends Component {
  ...
  componentDidMount () {
    this.setState({
      MemberLoan_ID: this.props.currentMemberLoan_ID,
  ...
  handleCreatedLoanTermsSubmit (e) {
    ...
    const { Loanee_MemberLoan_ID, Interest_On_Loan, Repayment_Schedule, Number_Of_Payments, Loanee_Pay_Pal_Data, Lenders_Pay_Pal_Info, Submit_Info } = this.state
